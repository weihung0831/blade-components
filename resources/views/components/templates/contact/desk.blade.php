@php
    $routes = [
        ...
        [
            ...
            'lead' => 'Where the parcel is, changing an address before it ships, and the ones customs has sat on for nine days.',
            'person' => 'Ping',
            'reply' => '2 h',
        ...
        [
            'name' => 'Dealers and wholesale',
            'lead' => 'Terms start at six machines a month. Below that you are better off buying from us at the retail price, and we will say so.',
            'person' => 'Ines',
            'reply' => '1 day',
            'window' => 'Tue and Thu',
            'open' => false,
            'bring' => ['shop name', 'city', 'volume'],
        ],
        [
            'name' => 'Press and everything else',
            'lead' => 'Photographs, a loan machine for a review, or a question that fits none of the boxes above.',
            'person' => 'Sofia',
            'reply' => '3 days',
            'window' => 'when the bench is quiet',
            'open' => false,
            'bring' => ['your deadline'],
        ],
    ];
...
<x-templates.contact.shell active="The desk">
    <x-slot:toolbar>
    ...
    <div class="mx-auto max-w-4xl">
        ...
        <section class="mt-10 flex flex-wrap items-center gap-x-6 gap-y-3 rounded-xl border border-jade-500/25 bg-jade-500/5 p-4">
            ...
            <a href="{{ route('templates.screen', ['faq', 'questions']) }}" target="_top"
                class="shrink-0 rounded-lg border border-white/12 px-3 py-1.5 text-[12px] text-zinc-300 transition-colors duration-150 hover:border-jade-500/60 hover:text-cream">Open the help centre</a>
        </section>
    </div>
