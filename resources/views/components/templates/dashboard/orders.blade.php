...
<x-templates.dashboard.shell active="Orders" title="Orders" :crumbs="[['label' => 'wharf', 'href' => '#'], ['label' => 'Commerce', 'href' => '#'], ['label' => 'Orders']]">
    <x-slot:actions>
        <x-ui.select :options="['This week', 'This month', 'This quarter']" value="This week" size="sm" name="orders-range" class="w-36" />
    ...
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <x-ui.card class="lg:col-span-2">
            ...
            <x-ui.animated-column-chart :items="$volume" height="h-44" />
        </x-ui.card>
        ...
        <x-ui.card>
            <x-slot:header>
                <div class="flex items-baseline justify-between">
                    ...
                    <x-ui.badge variant="dot" color="jade" class="py-0.5">Scheduled</x-ui.badge>
                </div>
            </x-slot>

            <p class="text-2xl font-semibold tracking-tight text-cream">
                <x-ui.number-ticker :value="179372.4" :decimals="2" prefix="$" />
            </p>
    ...
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <x-ui.card class="lg:col-span-2">
            ...
            <x-ui.animated-bar-chart :items="$products" :max="2100" label-width="w-24" />
        ...
        <x-ui.card>
            ...
            ]" label="Reason mix" total="252 refunds" />
            ...
            <x-ui.button variant="ghost" size="sm" class="mt-3 w-full">Review disputes</x-ui.button>
        </x-ui.card>
    </div>
