...
<div {{ $attributes->class('flex h-full w-full flex-col overflow-hidden bg-ink-950') }}>
    ...
    <header class="shrink-0 border-b border-white/5 bg-ink-950">
        <div class="flex h-14 items-center gap-5 px-4 sm:px-5">
            <a href="{{ route('templates.screen', ['invoice', 'document']) }}" target="_top" class="flex shrink-0 items-center gap-2.5">
            ...
            <nav class="hidden items-center gap-1 lg:flex">
                @foreach ($links as $link)
                    <a href="{{ route('templates.screen', ['invoice', $link['screen']]) }}" target="_top"
            ...
            <div class="ml-auto flex shrink-0 items-center gap-3">
                <a href="{{ route('templates.screen', ['invoice', 'ledger']) }}" target="_top"
                    class="hidden flex-col items-end leading-none transition-colors duration-150 hover:text-cream sm:flex">
                ...
                <a href="{{ route('templates.screen', ['invoice', 'compose']) }}" target="_top"
