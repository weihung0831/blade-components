...
<x-templates.auth.shell title="Join Northbeam Supply" subtitle="Aiden Lau invited you to the workspace as a developer.">
    <x-slot:action>
    ...
    <div class="mt-6 flex flex-col gap-2">
        <x-ui.button class="w-full">Accept and join</x-ui.button>
        <x-ui.button variant="ghost" class="w-full">Decline</x-ui.button>
    </div>
