...
<x-templates.refund.shell active="The ledger">
    <x-slot:toolbar>
        <div class="flex flex-wrap items-center gap-x-5 gap-y-2">
            ...
            <a href="{{ route('templates.screen', ['refund', 'policy']) }}" target="_top"
                class="ml-auto rounded-lg px-2.5 py-1 font-mono text-[11px] text-jade-400 transition-colors duration-150 hover:bg-white/5 hover:text-jade-300">the rules these came under →</a>
        </div>
    </x-slot:toolbar>
            ...
            <aside>
                ...
                <div class="mt-4 rounded-xl border border-white/8 bg-ink-900 p-4">
                    ...
                    <a href="{{ route('templates.screen', ['refund', 'send']) }}" target="_top"
                        class="mt-3 block rounded-lg border border-white/10 py-1.5 text-center text-[12px] text-zinc-300 transition-colors duration-150 hover:border-jade-500/60 hover:text-cream">Start one of your own</a>
                </div>
            </aside>
        </div>
    </div>
