...
<x-templates.privacy.shell active="Ask for it">
    <x-slot:toolbar>
        <div class="flex flex-wrap items-center gap-x-5 gap-y-2">
            ...
            <a href="{{ route('templates.screen', ['privacy', 'held']) }}" target="_top"
                class="ml-auto rounded-lg px-2.5 py-1 font-mono text-[11px] text-jade-400 transition-colors duration-150 hover:bg-white/5 hover:text-jade-300">see what is in it first →</a>
        </div>
    </x-slot:toolbar>
            ...
            <section>
                ...
                <div class="mt-3 divide-y divide-white/5 overflow-hidden rounded-xl border border-white/8 bg-ink-900">
                    @foreach ($files as $file)
                        <div class="flex flex-col gap-1.5 px-3.5 py-3 sm:flex-row sm:items-baseline sm:gap-5">
            ...
            <aside>
                ...
                <div class="mt-7 rounded-xl border border-white/8 bg-ink-900 p-4">
                    ...
                    <a href="{{ route('templates.screen', ['contact', 'desk']) }}" target="_top"
                        class="mt-3 block rounded-lg border border-white/10 py-1.5 text-center text-[12px] text-zinc-300 transition-colors duration-150 hover:border-jade-500/60 hover:text-cream">Find the right desk</a>
                </div>
