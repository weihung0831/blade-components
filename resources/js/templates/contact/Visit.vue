...
import ContactPlace from './Place.vue';
...
<template>
    <ContactShell active="Visit">
        <template #toolbar>
            <ContactHours zone="Taipei" time="04:12" :cursor="4.2" state="shut" :windows="[[14, 18]]" note="Counter opens Tue and Thu, 14:00" />
        </template>
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <section>
                            ...
                            <ul class="mt-3 space-y-2.5">
                                <li v-for="line in can" :key="line" class="flex gap-2.5 text-[12px]/5 text-zinc-500">
                ...
                <div>
                    <section>
                        ...
                        <div class="mt-3 divide-y divide-white/5 border-y border-white/5">
                            <div v-for="entry in bring" :key="entry.what" class="py-3">
