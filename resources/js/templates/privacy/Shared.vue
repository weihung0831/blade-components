...
import PrivacyHolder from './Holder.vue';
...
const count = computed(() => (picked.value === 'all' ? 'showing all nine' : `showing ${spell[shown.value.length]} of nine`));
</script>

<template>
    <PrivacyShell active="Who sees it">
        <template #toolbar>
        ...
        <div class="mx-auto max-w-6xl">
            ...
            <div class="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-[1.7fr_1fr]">
                <section>
                    ...
                    <p v-if="shown.length === 0" class="mt-3 text-[12px]/5 text-zinc-600">Nothing under this filter.</p>
                ...
                <aside>
                    ...
                    <div class="mt-3 divide-y divide-white/5 overflow-hidden rounded-xl border border-white/8 bg-ink-900">
                        <div v-for="country in countries" :key="country.name" class="px-3.5 py-3">
                    ...
                    <div class="mt-3 space-y-3">
                        <div v-for="refusal in refusals" :key="refusal.when" class="rounded-xl border border-white/8 bg-ink-900 p-3.5">
                            <p class="flex items-baseline gap-2">
