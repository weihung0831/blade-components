...
export function DashboardShell({ active = 'Overview', title = 'Overview', crumbs = [], actions = null, children }) {
    ...
    return (
        <div className="flex h-full w-full gap-3 overflow-hidden bg-ink-950 p-3 sm:gap-4 sm:p-4">
            <UiSidebar
                sections={sections}
            ...
            <div className="relative flex min-w-0 flex-1">
                <div data-ui-scroll-region className="flex min-w-0 flex-1 flex-col gap-3 overflow-y-auto sm:gap-4">
