...
import TermsClause from './Clause.vue';
    ...
    <TermsShell active="The terms">
        <template #toolbar>
            <div class="flex flex-wrap items-center gap-x-5 gap-y-2">
                ...
                <label class="ml-auto flex cursor-pointer items-center gap-2 rounded-lg border border-white/10 px-2.5 py-1 text-[12px] text-zinc-400 transition-colors duration-150 hover:border-white/20 hover:text-cream">
                    <input v-model="changedOnly" type="checkbox" class="size-3.5 accent-jade-500">
        ...
        <div class="mx-auto max-w-3xl">
            ...
            <p class="mt-1.5 max-w-2xl text-[13px]/6 text-zinc-500">
                ...
                <a href="/templates/terms/screens/plain" target="_top" class="text-jade-400 transition-colors duration-150 hover:text-jade-300">short version</a>,
            ...
            <div class="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
                <div class="rounded-xl border border-white/8 bg-ink-900 p-4">
                    ...
                    <ul class="mt-2.5 space-y-2">
                        <li v-for="line in covers" :key="line" class="flex gap-2.5 text-[12px]/5 text-zinc-400">
                ...
                <div class="rounded-xl border border-white/8 bg-ink-900 p-4">
                    ...
                    <ul class="mt-2.5 space-y-2">
                        <li v-for="line in doesNot" :key="line" class="flex gap-2.5 text-[12px]/5 text-zinc-500">
