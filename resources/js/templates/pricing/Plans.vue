...
import PricingPlanCard from './PlanCard.vue';
    ...
    >
        ...
        <section class="mt-12">
            ...
            <div class="mt-4 flex flex-wrap gap-1.5">
                <span v-for="feature in included" :key="feature" class="rounded-full border border-white/8 px-2.5 py-1 font-mono text-[11px] text-zinc-500">{{ feature }}</span>
            </div>
        </section>
