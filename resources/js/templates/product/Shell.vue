...
const finish = defineModel('finish', { type: String, default: 'graphite' });
...
<template>
    <div class="group/shell flex h-full w-full flex-col overflow-hidden bg-ink-950" :data-finish="finish">
                ...
                <header class="sticky top-0 z-30 flex h-14 shrink-0 items-center gap-4 border-b border-white/5 bg-ink-950/85 px-5 backdrop-blur sm:px-8">
                    ...
                    <div class="ml-auto flex shrink-0 items-center gap-2">
                        ...
                        <UiDropdown variant="ghost" align="right" class="md:hidden [&>summary]:h-8 [&>summary]:px-2.5 [&>summary]:text-[13px]">
                            ...
                            <template #menu>
                                <a href="/templates/product/screens/overview" target="_top" class="text-jade-300!">Grinders</a>
                ...
                <div class="sticky top-14 z-20 border-b border-white/5 bg-ink-950/85 backdrop-blur">
                    <div class="mx-auto flex w-full max-w-6xl flex-wrap items-center gap-x-5 gap-y-2 px-5 py-2.5 sm:px-8">
                        ...
                        <div class="ml-auto flex items-center gap-4">
                            <ProductFinishPicker v-model="finish" class="hidden sm:flex" />

                            <span class="hidden font-mono text-[13px] text-cream lg:block">{{ finish === 'jade' ? '$1,300' : '$1,180' }}</span>
